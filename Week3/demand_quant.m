function [profit,Mtime,demand,profitq] = demand(M,price,prob_day,prob_demand,Nsim)
    ...
    profit2 = sum(profit1) - buy;
    %average over Nsim simulations
    profit = sum(profit2) / Nsim;

    profitq = quantile(profit2,[.5 .05 .95]);
end